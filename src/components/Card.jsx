...
import money1 from '../assests/money1.svg';
import money2 from '../assests/money2.svg';
import money3 from '../assests/money3.svg';
  ...
  return (
    <div className='w-full py-[10rem] px-4 bg-white'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
        ...
        <div className='w-full shadow-lg bg-gray-100  flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
          <img
